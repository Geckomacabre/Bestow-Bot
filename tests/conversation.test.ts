...
describe('continuing the conversation', () => {
  ...
  test('the global router sends the button and the modal to these handlers', async () => {
    ...
    await onInteraction({ ...b.i, isAutocomplete: () => false, isButton: () => true, isStringSelectMenu: () => false, isUserSelectMenu: () => false, isModalSubmit: () => false } as any);
    ...
    const orig = console.error; console.error = () => {};
    try { await onInteraction({ ...m.i, isAutocomplete: () => false, isButton: () => false, isStringSelectMenu: () => false, isUserSelectMenu: () => false, isModalSubmit: () => true } as any); } finally { console.error = orig; }
